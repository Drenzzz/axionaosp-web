      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-4">
          <a href="https://t.me/AxionOS_android" target="_blank" rel="noopener noreferrer">
            <Button size="lg" variant="outline" className="testimonial-button-glow">Join us on Telegram</Button>
          </a>
          <Link href="/downloads">
            <Button size="lg" className="bg-green-300 hover:bg-green-400 text-black font-bold testimonial-button-glow">Download AxionOS</Button>
          </Link>
        </div>
      </div>
    </section>
