...
import { CodenamePill } from '../CodenamePill';
...
export const TeamMemberCard = ({ username, name, avatar, position }: { username: string, name: string, avatar: string, position: React.ReactNode }) => {
  return (
    <div className="group w-full h-full ">
      <div className="relative overflow-hidden bg-neutral-900/80 backdrop-blur-md border border-neutral-800 hover:border-green-400/40 p-6 flex flex-col items-center h-full transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-green-400/10 rounded-xl"> {/* Padding p-4 */}
        ...
        <div className="relative mb-2 z-10">
          ...
          <div className="relative">
            <Image
              ...
              width={80}
              height={80}
              className="rounded-full border-2 border-neutral-700 group-hover:border-green-400/60 object-cover transition-all duration-500 relative z-10"
              unoptimized
              loading="lazy"
            />
          </div>
        ...
        <div className="w-full mt-2 flex flex-col justify-start items-center z-10 max-h-16 overflow-y-auto custom-scrollbar pr-2 mb-auto">
        ...
        <a
          ...
          className="footer-icon-effect p-2.5 rounded-full bg-neutral-800/50 text-neutral-400 hover:text-white hover:bg-green-400/20 hover:shadow-lg hover:shadow-green-400/30 transition-all duration-300 z-10 group/icon mt-4"
